...
//   if (!validator.isAlphanumeric(eventName, "en-US", { ignore: "_-" })) {
//     console.log("Event name should not empty");
//     return setError("Event name can't be empty, whitespace not allowed");
//   }

//   if (!validator.isMobilePhone(eventCapacity, "th-TH")) {
//     console.log("Invalid phone number");
//     return setError("Invalid phone number");
//   }
//   if (!validator.isMobilePhone(eventLocation)) {
//     console.log("Invalid phone number");
//     return setError("Invalid phone number");
//   }
//   if (!validator.isAlphanumeric(description, "en-US", { ignore: "_-" })) {
//     console.log("Firstname must be characters");
//     return setError(
//       "First name must be characters; underscore allowed; whitespace not allowed"
//     );
//   }
//   if (!validator.isAlphanumeric(eventImage, "en-US", { ignore: "_-" })) {
//     console.log("Firstname must be characters");
//     return setError(
//       "First name must be characters; underscore allowed; whitespace not allowed"
//     );
